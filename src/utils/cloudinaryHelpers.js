...
export const cloudinaryPresets = {
   ...
   thumbnail: (url) => getCloudinaryUrl(url, { width: 200, height: 150, crop: 'fill' }),

   // Card de establecimiento en listados
   card: (url) => getCloudinaryUrl(url, { width: 600, height: 400, crop: 'fill' }),

   // Galería pública (imagen mediana)
   gallery: (url) => getCloudinaryUrl(url, { width: 800, height: 600, crop: 'limit' }),

   // Vista de detalle / hero
   detail: (url) => getCloudinaryUrl(url, { width: 1200, height: 900, crop: 'limit' }),

   // Tapa en card
   tapaCard: (url) => getCloudinaryUrl(url, { width: 400, height: 300, crop: 'fill' }),

   // Tapa en detalle
   tapaDetail: (url) => getCloudinaryUrl(url, { width: 800, height: 600, crop: 'limit' }),
};